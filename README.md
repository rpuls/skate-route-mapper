...
- The current Gate A firmware label is `calibration v3`; it sends compact BLE
...
- The mobile Calibration screen can upload short labeled experimental JSON
  captures to `POST /v1/mobile/experimental-captures`, including opt-in
  high-data-rate raw-burst captures.
